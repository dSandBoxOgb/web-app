...
- [Zustand](https://zustand.docs.pmnd.rs/getting-started/introduction) - Small, fast and scalable state management solution
- [TanStack Query](https://tanstack.com/query/latest/docs/framework/react/overview) - Powerful data synchronization for React (fetching, caching, synchronizing and updating server state)
